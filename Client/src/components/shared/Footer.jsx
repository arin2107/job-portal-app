            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-4 mt-4 md:mt-0">
                        <a href="https://www.instagram.com/arin._.vashishtha/" className="hover:text-gray-400" aria-label="Facebook">
                        ...
                        <a href="https://x.com/VashishthaArin" className="hover:text-gray-400" aria-label="Twitter">
                        ...
                        <a href="www.linkedin.com/in/arin-vashishtha-662176248/" className="hover:text-gray-400" aria-label="LinkedIn">
